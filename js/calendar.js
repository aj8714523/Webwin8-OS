  ...
  Calendar.prototype = {
    ...
    renderDOM: function () { // 渲染DOM
      ...
      var _titleStr = '<a href="#" class="title"></a>'+
                      ...
                      '</div>';
      var _weekStr = '<li class="item" style="color:red;">日</li>'+
                      '<li class="item">一</li>'+
                      '<li class="item">二</li>'+
                      '<li class="item">三</li>'+
                      '<li class="item">四</li>'+
                      '<li class="item">五</li>'+
                      '<li class="item" style="color:red;">六</li>';
      var _dateStr = '';
      ...
      for (var i = 0; i < 6; i++) {
        _dateStr += '<li class="item" style="color:red;">26</li>'+
                    '<li class="item">26</li>'+
                    '<li class="item">26</li>'+
                    '<li class="item">26</li>'+
                    '<li class="item">26</li>'+
                    '<li class="item">26</li>'+
                    '<li class="item" style="color:red;">26</li>';
      }
